...
namespace UsbLibrary
{
    ...
    public class Win32Usb
    {
        ...
        protected static extern bool HidD_SetOutputReport(IntPtr HidDeviceObject, byte[] ReportBuffer, int ReportBufferLength);
        /// <summary>
        ...
        ///<returns>'true' if successful.'false' otherwise. </returns> 
        [DllImport("hid.dll", SetLastError = true)]
        protected static extern bool HidD_GetInputReport(IntPtr HidDeviceObject, byte[] ReportBuffer, int ReportBufferLength); 
