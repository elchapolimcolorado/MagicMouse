...
/*/// <summary>
      ...
      /*  [Description("The event that occurs when data is recieved from the embedded system")]
        ...
        [Description("The event that occurs when data is recieved from the embedded system")]
        [Category("Embedded Event")]
        [DisplayName("OnDataRecieved_4")]
        public event DataRecievedEventHandler OnDataRecieved_4;

        [Description("The event that occurs when data is recieved from the embedded system")]
        [Category("Embedded Event")]
        [DisplayName("OnDataRecieved_5")]
        public event DataRecievedEventHandler OnDataRecieved_5;

        [Description("The event that occurs when data is recieved from the embedded system")]
        [Category("Embedded Event")]
        [DisplayName("OnDataRecieved_6")]
        public event DataRecievedEventHandler OnDataRecieved_6;
            ...
            try
            {
                ...
                if (specified_device != null)	// did we find it?
                {
                    if (OnSpecifiedDeviceArrived != null)
                    {
                        ...
                        specified_device.DataRecieved_4 += new DataRecievedEventHandler(OnDataRecieved_4);
                        specified_device.DataRecieved_5 += new DataRecievedEventHandler(OnDataRecieved_5);
                        specified_device.DataRecieved_6 += new DataRecievedEventHandler(OnDataRecieved_6);
     ...
     /*   private void DataRecieved(object sender, DataRecievedEventArgs args)
        ...
        private void DataRecieved_4(object sender, DataRecievedEventArgs args)
        {
            if (this.OnDataRecieved_4 != null)
            {
                this.OnDataRecieved_4(sender, args);
            }
        }
        private void DataRecieved_5(object sender, DataRecievedEventArgs args)
        {
            if (this.OnDataRecieved_5 != null)
            {
                this.OnDataRecieved_5(sender, args);
            }
        }
        private void DataRecieved_6(object sender, DataRecievedEventArgs args)
        {
            if (this.OnDataRecieved_6 != null)
            {
                this.OnDataRecieved_6(sender, args);
            }
        }
